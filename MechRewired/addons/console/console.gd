...
## The console is a development tool and is intentionally unavailable in release builds.
...
func _enter_tree() -> void:
	...
	# Keep the debug console readable over the battlefield while retaining a hint of
	# the scene underneath. This is a MechRewired presentation override.
	var panel_style := StyleBoxFlat.new()
	panel_style.bg_color = Color(0.01, 0.015, 0.025, 0.93)
