...
This file adds MechRewired-specific guidance to the shared repository instructions in the parent `AGENTS.md`.

## Delegation

- Optimize delegation for token cost rather than elapsed time. Waiting longer is acceptable.
- Delegate independent, bounded mechanical work to the least expensive sufficiently capable agent, even when delegation does not make the task finish sooner.
